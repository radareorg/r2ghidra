...
# radare2's wasi build already bundles a minimal zlib (otezip) whose inflate
# cannot resume across streamed input chunks as ghidra requires; carry a real
# zlib but prefix its symbols (zconf.h Z_PREFIX) so the two never clash.
R2GHIDRA_XPS_CFLAGS+=-DZ_PREFIX
endif
