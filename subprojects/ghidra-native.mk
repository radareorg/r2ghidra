...
WRAP_wrap_git_url:=https://github.com/radareorg/ghidra-native.git
...
ghidra-native:
	if [ ! -d "ghidra-native" -o "d2242691bf45a12e3ea483a4789f825af4651506" != "$(shell cd ghidra-native 2>/dev/null && git rev-parse HEAD)" ]; then rm -rf "ghidra-native"; ${MAKE} ghidra-native_all; fi

ghidra-native_all:
	git clone --no-checkout --depth=1 https://github.com/radareorg/ghidra-native.git ghidra-native
