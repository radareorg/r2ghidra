...
ghidra-native:
	if [ ! -d "ghidra-native" -o "a654296a4e3ecbcdd9f1036fd444cb487e89ee97" != "$(shell cd ghidra-native 2>/dev/null && git rev-parse HEAD)" ]; then rm -rf "ghidra-native"; ${MAKE} ghidra-native_all; fi
